...
[TsInterface]
public class JsUtilsAdapter(IJSRuntime js, IWebHostEnvironment webHostEnvironment) : IScoped, IAsyncDisposable, IJsUtils
{
    ...
    {
        return m ??= await js.ImportModule(webHostEnvironment, "./js/dist/jsutils.js", ct);
    }
}
